...
public class MenuState implements State {
    ...
    private int menuImageW = SolarFox.getMainWidth()+12;
    
    /**menuImageH variable of MenuState*/
    private int menuImageH = SolarFox.getMainHeight();
    ...
    private int aboutBtnX = SolarFox.getMainWidth() - 90;
    
    /**aboutBtnY variable of MenuState*/
    private int aboutBtnY = SolarFox.getMainHeight() - 100;
    ...
    private int versionX = SolarFox.getMainWidth() - 50;
    
    /**versionY variable of MenuState*/
    private int versionY = SolarFox.getMainHeight() - 40;
    ...
    */
    ...
    public void render(Graphics2D g){
		...
		SolarFox.setStatusBar("Quit?");
                
                //Set Quit Button Click Logic
                if (MouseInput.MouseButton == 1) {
                    Sound.stopAll();
                    Sound.btnPushed.play();
                    SolarFox.setStatusBar("Quit Game?");
