...
public class Level {
    ...
    private final int livesBonusTxtX = SolarFox.getMainWidth() / 6 - 30;
    
    /**livesBonusTxtY variable of Level*/
    private final int livesBonusTxtY = SolarFox.getMainHeight() - 465;
    
    /**timeBonusTxt variable of Level*/
    private String timeBonusTxt;
    
    /**timeBonusTxtX variable of Level*/
    private final int timeBonusTxtX = SolarFox.getMainWidth() / 6 - 30;
    
    /**timeBonusTxtY variable of Level*/
    private final int timeBonusTxtY = SolarFox.getMainHeight() - 465;
    
    /**levelBonusTxt variable of Level*/
    private String levelBonusTxt;
    
    /**levelBonusTxtX variable of Level*/
    private final int levelBonusTxtX = SolarFox.getMainWidth() / 6 - 30;
    
    /**levelBonusTxtY variable of Level*/
    private final int levelBonusTxtY = SolarFox.getMainHeight() - 465;
    ...
    private final int levelTxtX = SolarFox.getMainWidth() / 4 - 30;
    
    /**levelTxtY variable of Level*/
    private final int levelTxtY = SolarFox.getMainHeight() - 425;
...
//    public BufferedImage getBackground(int lNo){
//        BufferedImage newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        
//        if(lNo == 1) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        if(lNo == 2) newBI = new Texture("/Level/Breakout-Level-Background-GOLD_1").getImage();
//        if(lNo == 3) newBI = new Texture("/Level/Breakout-Level-Background-GREEN_1").getImage();
//        if(lNo == 4) newBI = new Texture("/Level/Breakout-Level-Background-RED_1").getImage();
//        if(lNo == 5) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        if(lNo == 6) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        if(lNo == 7) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        if(lNo == 8) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        if(lNo == 9) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        if(lNo == 10) newBI = new Texture("/Level/Breakout-Level-Background-BLUE_1").getImage();
//        
//        return newBI;
//    }
            ...
            if(levelComplete){
                ...
                for (levelCompleteCount = 0; levelCompleteCount < 500; levelCompleteCount++) {
                    ...
                    if (time / 450 % 2 == 0) {
                        ...
                        SolarFox.setStatusBar("Level "+Game.levelNo+" : "+getLevelName()+" Completed!!");    
                    } else {
...
//                    Sound.Level6.loop();
    ...
    public static void setLevelNo(int levNo){
        levelNo = levNo;
        Game.level = new Level(levelNo, SolarFox.getMainWidth(), SolarFox.getMainHeight());
    }
