...
//import com.LOGamez.explodes.EnExplode;
import java.awt.*;
    ...
    */
    public static void initUFO() {
        ...
        if(random.nextInt(Enemy.UFOfreq) == 0){
            ...
            UFO eufo_b = new UFO(SolarFox.getMainWidth()/2-40, SolarFox.getMainHeight()-100, false, 1, 1, enemyImg1);
            EnemiUFO.add(eufo_b);
        }
